...
from data import get_transform, collate_fn, ObliqueDataset
...
class ObjectDetectionTrial(PyTorchTrial):
    def __init__(self, context: det.TrialContext) -> None:
        ...
        # Create a unique data directory for each rank so they don't
        # overwrite each other.
        data_config = self.context.get_data_config()
        self.data_root = data_config["path"]
        # print("d_logs data_root : {}".format(self.data_root))
        print("d_logs : {}".format(os.path.isabs(self.data_root)))
        dataset = ObliqueDataset(self.data_root)
